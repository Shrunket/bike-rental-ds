...
Build a model using train dataset file: day.csv
The main aim of this project is to build a high performance model better than the existing one.
A Challenge for every data scientist.
